# System Design von "Old Book Wisenheimer"

## Product Design

- [obwh-product-design_de.md](../../2_Design/Product/obwh-product-design_de.md)

## System Vision

Siehe: 
- [obwh-system-vision_de.md](../../1_Vision/System/obwh-system-vision_de.md)

## API

Hier ein Vorschlag für die API:

Aus dieser API soll Code generiert werden, der im Angular Frontend und 
im Spring Boot Backend eingebunden werden kann.
...
Eine für die aktuelle Entwicklung, aber auch für zukünftige Entwicklungen 
tragfähige Verzeichnisstruktur.

Es soll einfach möglich sein, den aus der API generierten Code einzubinden.

Vorschlag: Gradle Multi Module Projekt

## Docker

Es soll Dockerfiles geben, damit das Backend und das Frontend auf Sliplane.io deployed werden kann.
